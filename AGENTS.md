...
**Current State**: Functional Video Poker game supporting "Jacks or Better" and "Deuces Wild". Features include Game Selection screen, Double Up, bankroll persistence, sound effects, and a robust MVVM architecture with navigation.
...
4.  **More Variants**: Joker Poker, Bonus Poker.
